...
/**
 * A simple client that requests a hello greeting from the {@link com.apidemo.grpc.HelloServer}.
 */
public class HelloClient {
  ...
  */
  ...
  /**
   * Greet Hello server. If provided, the first element of {@code args} is the name to use in the
